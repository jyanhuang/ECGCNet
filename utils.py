...
def get_data_set(number, X_data, Y_data):
    ...
    Rlocation = annotation.sample  # R波的位置信息，即R波在ECG信号中的样本索引
    Rclass = annotation.symbol  # R波的标签信息，即R波的类别或类型
...
def load_data(ratio, random_seed):
    numberSet = ['100', '101', '103', '105', '106', '107', '108', '109', '111', '112', '113', '114', '115',
                 ...
                 '231', '232', '233', '234']
    # numberSet = ['1002603', '1002867', '1003574', '1004502', '1005639', '1006637', '1007823', '1009404', '1009856',
    #              '1013179', '1015620', '1021036', '1027085']
    dataSet = []
    lableSet = []
    for n in numberSet:
